# Логика по созданию пользователя. Обрабатывает входящий запрос от пользователя
...
async def geta_user_by_id(user_id: UUID, db: AsyncSession = Depends(get_db)) -> ShowUser:
